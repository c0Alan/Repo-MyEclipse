...
// @author Artery
// @date 2011-10-10
// @id 1d0237e432d911f26670e68e92ff3a9a
// **********************************************//
...
function button881e4_onClickClient(rc, bookId, wrapId, formId) {
  ...
  Artery.parseItem({params: {itemid: 'formArea28f83', runTimeType: 'update', bookId: bookId, wrapId: wrapId}, callback: function(result) {
...
function button8009b_onClickClient(rc, form, wrapId) {
  ...
  Artery.parseItem({params: {itemid: 'blankPanelf549a', bookId: result, blankPanelf549a_id: wrapId}, callback: function(result) {
...
function button7c99d_onClickClient(rc, form, bookId, wrapId) {
  Artery.get(wrapId).removeItem(form);
  Artery.parseItem({params: {itemid: 'formAreacaeca', bookId: bookId, blankPanelf549a_id: wrapId}, callback: function(result) {
  Artery.get(wrapId).addItem(result, 'begin');
}});
}
