    ...
    return {
        ...
        getDialog : function(titleText){
           if(!dlg){
                ...
                buttons["ok"] = dlg.addButton({"text":bt["ok"],"cls":"x-dlg-btn-ok"}, handleButton.createCallback("ok"));
                buttons["yes"] = dlg.addButton({"text":bt["yes"],"cls":"x-dlg-btn-yes"}, handleButton.createCallback("yes"));
                buttons["no"] = dlg.addButton({"text":bt["no"],"cls":"x-dlg-btn-no"}, handleButton.createCallback("no"));
                buttons["cancel"] = dlg.addButton({"text":bt["cancel"],"cls":"x-dlg-btn-cancel"}, handleButton.createCallback("cancel"));
                buttons["ok"].hideMode = buttons["yes"].hideMode = buttons["no"].hideMode = buttons["cancel"].hideMode = 'offsets';
                buttons["yes"].on('mouseover',function(){
					this.el.addClass('x-btn-yes-over');	
				},buttons["yes"]);
				buttons["yes"].on('mouseout',function(){
					this.el.removeClass('x-btn-yes-over');	
				},buttons["yes"]);
            	buttons["no"].on('mouseover',function(){
					this.el.addClass('x-btn-no-over');	
				},buttons["no"]);
				buttons["no"].on('mouseout',function(){
					this.el.removeClass('x-btn-no-over');	
				},buttons["no"]);
