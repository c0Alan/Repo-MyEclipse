...
infosoftglobal.FusionCharts.prototype = {
	...
	getSWFHTML: function() {
		...
		if (navigator.plugins && navigator.mimeTypes && navigator.mimeTypes.length) { 
			...
			swfNode = '<object id="'+ this.getAttribute('id') +'" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase='+ sys.getContextPath() +'"/artery/arteryConsole/ocx/Flash32_12_0_0_77.ocx#version=12.0.0.77"  class="FusionCharts" width="'+ this.getAttribute('width') +'" height="'+ this.getAttribute('height') +'">';
