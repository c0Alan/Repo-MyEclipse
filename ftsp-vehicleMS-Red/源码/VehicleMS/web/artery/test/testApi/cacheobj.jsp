...
public class Cache {
    public NormalCodeService normalcode;
    public ClassCodeTreeService classcode;
    public EFormTplService formtemplate;
    public DictCache datadic;
    public PicService piclib;
    public ConfigService config;
    public SubsysService subsys;
    public FormTplMetaLogic formtplmeta;
}
</pre>
  </body>
</html>
